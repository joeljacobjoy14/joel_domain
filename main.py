...
def FF(vol, l, b, t, cm, lcb, Cstern=10):
    """
...
def RW(vol, l, b, t, cm, lcb, cwp, tf, abt, hb, at, v, rho=1.025): 
    """
...
def RTOT(vol, l, b, t, cm, lcb, cwp, tf, abt, hb, sapp, at, v, Cstern, \
                                                                  rho=1.025):
    rf = RF(vol, l, t, b, cm, cwp, abt, v)
    k1 = FF(vol, l, b, t, cm, lcb, Cstern)
    rapp = RAPP(l, v, sapp, rho)
